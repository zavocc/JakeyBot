...
from cogs.openai.generative import BaseChat
from discord.ext import commands
from os import environ
import discord

class OAIChat(BaseChat):
    ...
    async def oai_feature(self, ctx, capability: str):
